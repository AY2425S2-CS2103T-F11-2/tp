...
with(this){return _c('ul',[_c('li',[_v("Example Usage:\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe g/m h/1.75 w/70.00 no/98765432 e/john@example.com a/123 Street d/low sodium pr/high m/2025-12-31 al/peanuts")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("When a user issues a command such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John d/regular")]),_v("(simplified for this example, this command does not actually run in VitaBook), the following sequence of operations occurs:")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Shortcut: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("pr")]),_v(" can be used in place of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority")]),_v(".")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Example usage: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter d/low fat")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Case Insensitivity: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter")]),_v(" takes in values that are case-insensitive (e.g., d/Low Fat matches low fat).")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Speed")]),_v(": Perform tasks 3x faster than GUI apps with keyboard-only commands (e.g., add a patient in under 10 seconds).")]),_v(" "),_c('li',[_c('strong',[_v("Organization")]),_v(": Filter/sort patients by diet, priority, or meeting date with simple commands (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter d/low carb")]),_v(").")]),_v(" "),_c('li',[_c('strong',[_v("Portability")]),_v(": Runs on any OS (Windows/macOS/Linux) with Java 17+—no installation needed. Just launch the JAR file.")]),_v(" "),_c('li',[_c('strong',[_v("Data Control")]),_v(": Human-editable JSON storage for easy backups and manual edits.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Critical")]),_v(": Always back up "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("data/vitabook.json")]),_v(" before testing destructive commands ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(").")])}
},function anonymous(
) {
