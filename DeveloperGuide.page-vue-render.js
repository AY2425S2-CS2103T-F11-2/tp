...
with(this){return _c('p',[_v("When a user issues a command such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John d/low sodium")]),_v("(simplified for this example, this command does not actually run in VitaBook), the following sequence of operations occurs:")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Example usage: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter d/low sodium")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Case Insensitivity: Filters are case-insensitive (e.g., d/low sodium matches Low Sodium).")])])}
},function anonymous(
) {
