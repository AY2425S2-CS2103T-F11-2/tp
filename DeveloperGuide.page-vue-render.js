...
with(this){return _c('h2',{attrs:{"id":"about-us"}},[_c('strong',[_v("About Us")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#about-us","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("Should respond within 5 seconds for most user interactions.")]),_v(" "),_c('li',[_v("The application should be portable, working without an installer. It should be distributed in a single JAR file for easy execution on different platforms.")]),_v(" "),_c('li',[_v("Data should be stored in a human-editable file, ensuring that the nutritionist can manually back up or recover patient data if needed.")]),_v(" "),_c('li',[_v("The GUI should work well for standard screen resolutions 1920x1080 and higher, and, for screen scales 100% and 125%.")]),_v(" "),_c('li',[_v("The GUI should be usable for resolutions 1280x720 and higher, and, for screen scales 150%.")]),_v(" "),_c('li',[_v("The application should not use a DBMS to store data.")]),_v(" "),_c('li',[_v("The product's file size, including the JAR file and necessary assets, should not exceed 100MB.")]),_v(" "),_c('li',[_v("The user guide (UG) and design document (DG) should each be under 15MB, with optimized images and content to meet the file size limit.")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("ID")]),_v(" "),_c('th',[_v("Requirement")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("C1")]),_v(" "),_c('td',[_v("Works on "),_c('strong',[_v("Windows 10+, macOS 12+, Linux (Ubuntu 20.04+)")]),_v(" with Java 17+.")])]),_v(" "),_c('tr',[_c('td',[_v("C2")]),_v(" "),_c('td',[_v("Supports screen resolutions ≥1280x720 at 100-150% scaling.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("ID")]),_v(" "),_c('th',[_v("Requirement")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("D1")]),_v(" "),_c('td',[_v("Auto-saves to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("./data/vitabook.json")]),_v(" after every modifying command.")])]),_v(" "),_c('tr',[_c('td',[_v("D2")]),_v(" "),_c('td',[_v("Data file must be human-editable (plaintext JSON) for emergency recovery.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("ID")]),_v(" "),_c('th',[_v("Requirement")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("SC1")]),_v(" "),_c('td',[_v("Supports up to "),_c('strong',[_v("1,000 patients")]),_v(" without performance degradation.")])]),_v(" "),_c('tr',[_c('td',[_c('em',[_v("{More to be added}")])]),_v(" "),_c('td')])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 3 Apr 2025, 17:48:08 GMT+8]")])])])}
}];
