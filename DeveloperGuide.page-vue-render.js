...
with(this){return _c('ul',[_c('li',[_v("Example Usage:\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe g/m h/1.75 w/70.00 no/98765432 e/john@example.com a/123 Street d/vegan pr/high m/2025-12-31 al/peanuts")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Example Usage:\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 no/91234567 e/new@example.com")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("| Command       | Edge Case                                   | System Response                                          | Handling Mechanism                  |\n|-------------- -|-"),_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_v("|")])])])])])])])])])])])])])])])])])])])])])]),_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_c('span',{staticClass:"small"},[_v("|")])])])])])])]),_v("-----------------------|\n| "),_c('strong',[_v("Add")]),_v("       | Duplicate patient (same name + phone)       | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"This person already exists in VitaBook\"")]),_v("               | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommand#execute()")]),_v(" checks "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.hasPerson()")]),_v(" |\n|               | Missing required fields (e.g., no "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("n/NAME")]),_v(") | Shows "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MESSAGE_USAGE")]),_v(" with format                        | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommandParser")]),_v(" validates prefixes |\n|               | Invalid field format (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("h/abc")]),_v(")        | Field-specific error (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Height must be a number\"")]),_v(") | Field class constructors validate input |\n| "),_c('strong',[_v("Edit")]),_v("      | Invalid index (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 999")]),_v(")            | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Invalid patient index\"")]),_v("                                | Checks "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("index.getZeroBased() >= list.size()")]),_v(" |\n|               | No fields edited                            | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"At least one field to edit must be provided\"")]),_v("          | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EditPersonDescriptor#isAnyFieldEdited()")]),_v(" |\n|               | Duplicate after edit                        | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"This patient already exists in VitaBook\"")]),_v("              | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.hasPerson()")]),_v(" check           |\n| "),_c('strong',[_v("Clear")]),_v("     | Empty address book                          | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Nothing on list!\"")]),_v("                                     | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.getAddressBook().isEmpty()")]),_v(" check |\n|               | User cancels confirmation                   | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Clear command cancelled\"")]),_v("                              | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ClearDialogUtil.showConfirmationDialog()")]),_v(" |\n| "),_c('strong',[_v("Priority")]),_v("  | Invalid priority value (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("pr/INVALID")]),_v(") | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Priority must be low, medium, or high\"")]),_v("                | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Priority")]),_v(" enum validation          |\n|               | Invalid index                               | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Invalid patient index\"")]),_v("                                | Index bounds check                  |\n| "),_c('strong',[_v("Sort")]),_v("      | Invalid sort type (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort invalid")]),_v(")    | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Invalid sort type. Use: priority/name/diet\"")]),_v("           | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("switch")]),_v(" default case throws error  |\n|               | Empty list                                  | Silent (no action)                                       | Implicit in sorting logic           |\n| "),_c('strong',[_v("Filter")]),_v("    | Invalid prefix (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter x/abc")]),_v(")       | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Unexpected error: invalid filter prefix\"")]),_v("              | Default "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("switch")]),_v(" case               |\n|               | No matches                                  | Empty list (no error)                                    | Predicate returns "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("false")]),_v(" for all   |\n| "),_c('strong',[_v("Undo/Redo")]),_v(" | Undo at initial state                       | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"No previous state to undo\"")]),_v("                            | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.canUndoAddressBook()")]),_v(" check  |\n|               | Redo at latest state                        | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"No next state to redo\"")]),_v("                                | "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("model.canRedoAddressBook()")]),_v(" check  |\n|               | Non-modifying command (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(")        | No state change                                          | Skips "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#commitAddressBook()")]),_v("   |\n|               |  Executing a new command after an undo      | Purges the redo history                                  |"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook#commit()")]),_v("       |")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("No.")]),_v(" "),_c('th',[_v("MSS")]),_v(" "),_c('th',[_v("Extensions")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("1")]),_v(" "),_c('td',[_v("Nutritionist wants to view all registered patients.")]),_v(" "),_c('td',[_v("N.A.")])]),_v(" "),_c('tr',[_c('td',[_v("2")]),_v(" "),_c('td',[_v("Nutritionist types the list command.")]),_v(" "),_c('td',[_v("N.A.")])]),_v(" "),_c('tr',[_c('td',[_v("3")]),_v(" "),_c('td',[_v("VitaBook displays the complete list of patients, ordered by the order of entry or by the last sort criteria applied. Use case ends.")]),_v(" "),_c('td',[_v("(a) If the patient list was previously sorted, listing will display the full list sorted by the last sort criteria. "),_c('br'),_v(" (b) If the patient list was previously filtered, listing will reset the list to show all patients (full list).")])])])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("No.")]),_v(" "),_c('th',[_v("MSS")]),_v(" "),_c('th',[_v("Extensions")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("1")]),_v(" "),_c('td',[_v("Nutritionist identifies a patient whose details need updating.")]),_v(" "),_c('td',[_v("N.A.")])]),_v(" "),_c('tr',[_c('td',[_v("2")]),_v(" "),_c('td',[_v("Nutritionist types the edit command followed by the patient's index and the updated fields.")]),_v(" "),_c('td',[_v("No fields are provided to update."),_c('br'),_v("  (a) VitaBook displays an error indicating at least one field is required.")])]),_v(" "),_c('tr',[_c('td',[_v("3")]),_v(" "),_c('td',[_v("VitaBook validates the index and ensures the patient exists.")]),_v(" "),_c('td',[_v("Index is invalid."),_c('br'),_v("  (a) VitaBook displays an index error message."),_c('br'),_v("  (b) Nutritionist re-enters the command with a valid index.")])]),_v(" "),_c('tr',[_c('td',[_v("4")]),_v(" "),_c('td',[_v("VitaBook validates all provided input fields.")]),_v(" "),_c('td',[_v("A field contains invalid data."),_c('br'),_v("  (a) VitaBook displays specific validation errors."),_c('br'),_v("  (b) Nutritionist corrects and retypes the command.")])]),_v(" "),_c('tr',[_c('td',[_v("5")]),_v(" "),_c('td',[_v("VitaBook updates the patient information accordingly.")]),_v(" "),_c('td',[_v("Patient is edited from a filtered list "),_c('br'),_v(" (a) VitaBook uses the filtered index correctly.")])]),_v(" "),_c('tr',[_c('td',[_v("6")]),_v(" "),_c('td',[_v("VitaBook displays a confirmation message with updated details. After editing, VitaBook returns to displaying the full list, ordered by the order of entry or by the last sort criteria applied. Use case ends.")]),_v(" "),_c('td',[_v("N.A.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("No.")]),_v(" "),_c('th',[_v("MSS")]),_v(" "),_c('th',[_v("Extensions")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("1")]),_v(" "),_c('td',[_v("Nutritionist wants to add or update a note about a patient’s condition or behavior.")]),_v(" "),_c('td',[_v("N.A.")])]),_v(" "),_c('tr',[_c('td',[_v("2")]),_v(" "),_c('td',[_v("Nutritionist enters the remark command followed by the index of the patient and the remark content.")]),_v(" "),_c('td',[_v("No remark content is provided."),_c('br'),_v("  (a) VitaBook clears the existing re mark and confirms the update.")])]),_v(" "),_c('tr',[_c('td',[_v("3")]),_v(" "),_c('td',[_v("VitaBook validates the index.")]),_v(" "),_c('td',[_v("Index is invalid."),_c('br'),_v("  (a) VitaBook displays an error."),_c('br'),_v("  (b) Nutritionist corrects the index.")])]),_v(" "),_c('tr',[_c('td',[_v("4")]),_v(" "),_c('td',[_v("VitaBook updates or adds the remark for the patient.")]),_v(" "),_c('td',[_v("Patient is added/edited from a filtered list "),_c('br'),_v(" (a) VitaBook uses the filtered index correctly.")])]),_v(" "),_c('tr',[_c('td',[_v("5")]),_v(" "),_c('td',[_v("VitaBook displays a success message. After adding/editing, VitaBook returns to displaying the full list, ordered by the order of entry or by the last sort criteria applied. Use case ends.")]),_v(" "),_c('td',[_v("N.A.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("No.")]),_v(" "),_c('th',[_v("MSS")]),_v(" "),_c('th',[_v("Extensions")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("1")]),_v(" "),_c('td',[_v("Nutritionist wants to view patients by a specific criterion (e.g. diet, gender).")]),_v(" "),_c('td',[_v("N.A.")])]),_v(" "),_c('tr',[_c('td',[_v("2")]),_v(" "),_c('td',[_v("Nutritionist types the filter command followed by a valid prefix and value (e.g. d/low sugar).")]),_v(" "),_c('td',[_v("The filter prefix is invalid."),_c('br'),_v("  (a) VitaBook displays an error message with correct format.")])]),_v(" "),_c('tr',[_c('td',[_v("3")]),_v(" "),_c('td',[_v("VitaBook applies the filter and displays matching patients, ordered by the order of entry or by the last sort criteria applied. Use case ends.")]),_v(" "),_c('td',[_v("No patients match the filter."),_c('br'),_v("  (a) VitaBook displays an empty list message.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Term")]),_v(" "),_c('th',[_v("Definition")]),_v(" "),_c('th',[_v("Example/Notes")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('strong',[_v("Patient")])]),_v(" "),_c('td',[_v("An individual under nutritional care with stored health/dietary data.")]),_v(" "),_c('td',[_v("Created via "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe d/low fat")])])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("Nutritionist")])]),_v(" "),_c('td',[_v("Healthcare professional managing patient diets via VitaBook.")]),_v(" "),_c('td',[_v("Primary user of the application.")])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("CLI")])]),_v(" "),_c('td',[_v("Command-Line Interface for text-based commands.")]),_v(" "),_c('td',[_v("Faster than GUI (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 no/98765432")]),_v(" updates phone number).")])]),_v(" "),_c('tr',[_c('td',[_c('strong',[_v("GUI")])]),_v(" "),_c('td',[_v("Graphical User Interface (minimal use in VitaBook).")]),_v(" "),_c('td',[_v("Only displays results (e.g., patient lists).")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Note:")]),_v(" These instructions provide a foundation for testers. Exploratory testing is encouraged."),_c('br')])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Disclaimer:")]),_v(" VitaBook does not support localization. Only English characters are accepted for patient data, and the UI and messages are in English.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Test Case")]),_v(" "),_c('th',[_v("Prerequisite")]),_v(" "),_c('th',[_v("Expected Outcome")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority 2 pr/high")])]),_v(" "),_c('td',[_v("≥2 patients")]),_v(" "),_c('td',[_v("Updates priority of patient 2 to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("high")])])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority 1 pr/urgent")])]),_v(" "),_c('td',[_v("≥1 patient")]),_v(" "),_c('td',[_v("Error: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Priority must be high, medium, or low\"")])])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("priority 10 pr/high")])]),_v(" "),_c('td',[_v("<10 patients")]),_v(" "),_c('td',[_v("Error: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("\"Invalid patient index\"")])])])])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"1-allow-sorting-by-descending-order-for-name-diet-and-meeting-date"}},[_v("1. Allow sorting by descending order for name, diet, and meeting date"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#1-allow-sorting-by-descending-order-for-name-diet-and-meeting-date","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Currently, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" command only supports sorting in ascending order for name (A–Z), diet (A–Z), and meeting date (earliest to latest).\nThere is no option to sort by descending order (e.g., Z–A by name, latest meeting date first).\nWe plan to enhance the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort")]),_v(" command to support descending order sorting.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("The proposed changes are: Add an optional "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("/desc")]),_v(" flag to the sort command.")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort name /desc")]),_v(" → sorts patient names from Z–A.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort diet /desc")]),_v(" → sorts diets from Z–A.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort meetingdate /desc")]),_v(" → sorts by latest meeting date first.")]),_v(" "),_c('li',[_v("If "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("/desc")]),_v(" is not provided, sorting will default to ascending order (current behavior).")]),_v(" "),_c('li',[_v("This improvement will allow users to view records in their preferred order more flexibly.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"2-support-multiple-field-filters-in-a-single-filter-command"}},[_v("2. Support multiple field filters in a single filter command"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#2-support-multiple-field-filters-in-a-single-filter-command","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Currently, VitaBook’s "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter")]),_v(" command supports filtering by only one field (e.g., priority, diet, gender, or meeting date) at a time.\nUsers cannot filter by multiple fields simultaneously (e.g., find all patients who have priority 'low' and gender 'female').\nWe plan to enhance the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter")]),_v(" command to support multiple fields being combined in a single filter.")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter pr/low g/f")]),_v(" → finds all patients with priority \"low\" and gender \"female\".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter d/low fat m/2025-05-01")]),_v(" → finds all patients who have low fat diet and have a meeting on 2025-05-01.")]),_v(" "),_c('li',[_v("Multiple fields will be combined using logical AND by default.")]),_v(" "),_c('li',[_v("This improvement will make patient searching much more powerful and flexible for users managing large databases.")])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"3-allow-specifying-multiple-restricted-diets-for-a-patient"}},[_v("3. Allow specifying multiple restricted diets for a patient"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#3-allow-specifying-multiple-restricted-diets-for-a-patient","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
